                            ...
                            <ul>                                
                                <li></i> {{Auth::user()->name }}  
                                    <form method="POST" action="{{ route('logout')}}">
                                        @csrf
                                    <a href="{{ route('logout')}}" onclick="event.preventDefault(); this.closest('form').submit();"><img src="{{asset('assets/imgs/theme/icons/icon-logout.png')}}"></a>
                                    </form>
                                </li>
                            </ul>
                            @else
                            <ul>                                
                                <li></i><a href="{{ route('login')}}"><img src="{{asset('assets/imgs/theme/icons/icon-user.png')}}"></a></li>
                            </ul>
                            @endif
                        </div>
                ...
                <div class="mobile-menu-wrap mobile-header-border">
                    ...
                    <nav>
                        <ul class="mobile-menu">
                            <li class="menu-item-has-children"><span class="menu-expand"></span><a class="active" href="/">Home</a></li>
                            ...
                            @auth
                            <li class="menu-item-has-children"><span class="menu-expand"></span><a href="#">My Account<i class="fi-rs-angle-down"></i></a>
                                @if(Auth::user()->utype == 'ADM')
                                <ul class="sub-menu">
                                    <li><a href="{{route('admin.dashboard')}}">Dashboard</a></li>
                                    <li><a href="{{route('admin.products')}}">Products</a></li>
